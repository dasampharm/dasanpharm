        ...
        <div style={{ marginTop: "40px", width: "100%", overflowX: "auto" }}>
          {selectedDrug && (
            <div style={{ marginBottom: "16px" }}>
              <div style={{ fontSize: "16px" }}>성분: {selectedDrug["성분"]}</div>
              <div style={{ fontSize: "16px" }}>용량: {selectedDrug["용량"]}</div>
            </div>
          )}
              ...
              <tbody>
                {getFilteredDrugs().map((drug, index) => (
                  <tr key={index}>
                    ...
                    <td style={{ padding: "14px", border: "1px solid #eee", whiteSpace: "normal", overflowWrap: "break-word" }}>{drug["제약사"]}</td>
