// 약물 검색 React App (최종 수정 - 텍스트 줄바꿈 + 스크롤 수정)
    ...
    <div style={{ padding: "20px", fontFamily: "sans-serif", maxWidth: "380px", margin: "0 auto" }}>
      ...
      {(selectedDrug || selectedCategory) && (
        <div style={{ marginTop: "40px", width: "100%", overflowX: "auto" }}>
          ...
          <div style={{ minWidth: "800px", maxHeight: "300px", overflowY: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "collapse", tableLayout: "fixed" }}>
              <thead>
                <tr>
                  <th style={{ position: "sticky", top: 0, left: 0, zIndex: 4, backgroundColor: "#f7f7f7", padding: "12px", border: "1px solid #ccc", textAlign: "left", maxWidth: "10em", whiteSpace: "normal", overflowWrap: "break-word", wordBreak: "break-word" }}>제품명</th>
                  {["성분", "용량", "제약사", "약가", "요율", "환산액", "품절", "비고"].map((label, i) => (
                    <th key={i} style={{ position: "sticky", top: 0, backgroundColor: "#f7f7f7", zIndex: 2, padding: "12px", border: "1px solid #ccc", textAlign: "left", whiteSpace: "normal", overflowWrap: "break-word", wordBreak: "break-word" }}>{label}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
                {getFilteredDrugs().map((drug, index) => (
                  <tr key={index}>
                    <td style={{ position: "sticky", left: 0, backgroundColor: "#fff", zIndex: 1, padding: "12px", border: "1px solid #eee", maxWidth: "10em", whiteSpace: "normal", overflowWrap: "break-word", wordBreak: "break-word" }}>{drug["제품명"]}</td>
                    <td style={{ padding: "12px", border: "1px solid #eee", whiteSpace: "normal", overflowWrap: "break-word", wordBreak: "break-word" }}>{drug["성분"]}</td>
                    <td style={{ padding: "12px", border: "1px solid #eee", whiteSpace: "normal", overflowWrap: "break-word", wordBreak: "break-word" }}>{drug["용량"]}</td>
                    <td style={{ padding: "12px", border: "1px solid #eee", whiteSpace: "normal", overflowWrap: "break-word", wordBreak: "break-word" }}>{drug["제약사"]}</td>
                    <td style={{ padding: "12px", border: "1px solid #eee", whiteSpace: "normal", overflowWrap: "break-word", wordBreak: "break-word" }}>{drug["약가"]}</td>
                    <td style={{ padding: "12px", border: "1px solid #eee", whiteSpace: "normal", overflowWrap: "break-word", wordBreak: "break-word" }}>{drug["요율"]}</td>
                    <td style={{ padding: "12px", border: "1px solid #eee", whiteSpace: "normal", overflowWrap: "break-word", wordBreak: "break-word" }}>{drug["환산액"]}</td>
                    <td style={{ padding: "12px", border: "1px solid #eee", whiteSpace: "normal", overflowWrap: "break-word", wordBreak: "break-word" }}>{drug["품절"]}</td>
                    <td style={{ padding: "12px", border: "1px solid #eee", whiteSpace: "normal", overflowWrap: "break-word", wordBreak: "break-word" }}>{drug["비고"]}</td>
                  </tr>
                ))}
              </tbody>
            </table>
